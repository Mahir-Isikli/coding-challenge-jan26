...
export async function POST(req: Request) {
  try {
    ...
    // 1. Call edge function to create apple + find match
...
A new apple just joined! Here's their profile:
${data.apple?.description || 'No description available'}

${data.match ? `
MATCH FOUND!
- Matched with: ${data.match.orangeId}
...
1. Welcomes the apple (1 sentence)
2. Announces the match with the orange (1-2 sentences)
